...
<form action="./php/user_register_process.php" method="POST">
    <i class="fa-solid fa-xmark" id="btn-close-register"></i>
    <h2>Đăng ký</h2>
    ...
    <div class="input-box">
        ...
        <input type="text" name="username" id="" required placeholder="Tên người dùng">
    </div> 

    <div class="input-box">
        <label for="">Email</label>
        <input type="email" name="email" id="" required placeholder="Tên đăng nhập">
    </div>
